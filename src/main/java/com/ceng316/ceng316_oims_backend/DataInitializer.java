...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        iztechUserRepository.save(new IztechUser("Admin", "admin@admin.com", "123", Role.SYSTEM_ADMIN, "58974826485", "0555 555 55 55"));
        iztechUserRepository.save(new IztechUser("Department Secretary", "sec@sec.com", "123", Role.DEPARTMENT_SECRETARY, "58974826485", "0555 555 55 55"));

        IztechUser student = new IztechUser("Berk Şengül", "berk@std.iyte.edu.tr", "123", Role.STUDENT, "58974826485", "0555 555 55 55", 1);
        student.setGrade("3");
        student.setSchoolId("280201015");

        IztechUser student1 = new IztechUser("Emre Erol", "emre@std.iyte.edu.tr", "123", Role.STUDENT, "58974826485", "0555 555 55 55", 1);
        student1.setGrade("3");
        student1.setSchoolId("280201014");

        iztechUserRepository.save(student);
        iztechUserRepository.save(student1);
        iztechUserRepository.save(new IztechUser("Buket Öksüzoğlu", "buket@iyte.edu.tr", "123", Role.SUMMER_PRACTICE_COORDINATOR, "58974826485", "0555 555 55 55"));
